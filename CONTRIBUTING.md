Contributing to fictecpagos Core
============================

The fictecpagos Core project operates an open contributor model where anyone is
...
The following applies to code changes to the fictecpagos Core project, and is not to be
confused with overall fictecpagos Network Protocol consensus changes.

Whether a pull request is merged into fictecpagos Core rests with the project merge
...
Patches that change fictecpagos consensus rules are considerably more involved than
...
Where a patch set proposes to change the fictecpagos consensus, it must have been
...
The project leader is the release manager for each fictecpagos Core release.
