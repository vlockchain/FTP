...
In order to support loading of multiple wallets in fictecpagos-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fictecpagos.cpp.
...
Changes to fictecpagos.cpp
----------------------
fictecpagos.cpp is the entry point into fictecpagos-qt, and as such, will require some minor modifications to provide hooks for
