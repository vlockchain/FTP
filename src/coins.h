...
/** 
    ...
    ****Note - for fictecpagos we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of fictecpagos coming in to a transaction
