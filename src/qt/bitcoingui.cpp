                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("fictecpagos Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a fictecpagos address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fictecpagos: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About fictecpagos Core"), this);
    aboutAction->setStatusTip(tr("Show information about fictecpagos Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for fictecpagos"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your fictecpagos addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified fictecpagos addresses"));
    ...
    openAction->setStatusTip(tr("Open a fictecpagos: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the fictecpagos Core help message to get a list with possible fictecpagos command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("fictecpagos Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to fictecpagos network", "", count));
}
...
{
    QString strTitle = tr("fictecpagos Core"); // default title
