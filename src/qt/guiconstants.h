...
/* fictecpagos GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "fictecpagos"
#define QAPP_ORG_DOMAIN "fictecpagos.org"
#define QAPP_APP_NAME_DEFAULT "fictecpagos-Qt"
#define QAPP_APP_NAME_TESTNET "fictecpagos-Qt-testnet"
