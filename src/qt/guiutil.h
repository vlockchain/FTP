...
/** Utility functions used by the fictecpagos Qt UI.
 */
namespace GUIUtil
{
...
// Render fictecpagos addresses in monospace font
...
// Parse "fictecpagos:" URI into recipient object, return true on successful parsing
