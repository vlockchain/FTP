...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("fictecpagos Core"),
     ...
     * override -datadir in the fictecpagos.conf file in the default data directory
     * (to be consistent with fictecpagosd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
