...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("fictecpagos Core fictecpagos-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fictecpagos-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fictecpagos transaction") + "\n" +
                               "  fictecpagos-tx [options] -create [commands]   " + _("Create hex-encoded fictecpagos transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fictecpagos transaction
